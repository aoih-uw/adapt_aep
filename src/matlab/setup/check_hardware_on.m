...
% Grouped checklist
groups = { ...
    'Audio',        {'Hydrophone amp ON @ 3.16 mV/Pa', 'Speaker amp ON', 'Oscilloscope ON'}; ...
    'Recording',    {'Bioamp ON, gain 10,000x'}; ...
    'Tank & table', {'Water pump ON (Current 0.2, Voltage 5.0)', 'Nitrogen ON, table floating'}; ...
    'Temperature',  {'Temp within 1° of initial', '3 Ice bags in cooler', 'Set timer to remind noting temp every 15 minutes'}};
