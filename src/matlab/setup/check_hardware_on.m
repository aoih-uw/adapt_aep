...
groups = { ...
    ...
    'Tank & table', {'Water pump ON (Current 0.3, Voltage 7.3)', 'Nitrogen ON, table floating'}; ...
    'Temperature',  {'Temp within 2° of initial', 'Ice bag (~1000 g) on tank', 'Ice timer set (replace hourly)'}};
