...
groups = { ...
    ...
    'Recording',    {'Bioamp ON, gain 10,000x, confirm filter range'}; ...
    'Tank & table', {'Water pump ON (Current 0.2, Voltage 5.0)', 'Nitrogen ON, table floating','Hydrophone is unobstructed'}; ...
    'Temperature',  {'Temp between 12-13° C', 'Ice bag in tank removed', 'Set 15 min repeating timer'}; ...
...
% Create dialog
d = dialog('Position', [400 100 dlgW dlgH], ...
