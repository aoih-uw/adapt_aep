...
ex.info.experiment = struct( ...
    ...
    'drug_concentration',    'Anesthetic: 0.025%, 1 ml of 10% solution of Benzocaine in ethynol per 400 ml of water bath; Paralytic: 3 mg kg−1 ', ...
...
ex.info.animal = struct( ...
    'species_name',          'hydrolagus_colliei', ...
...
ex.info.stimulus = struct( ...
    ...
    'full_amplitude_duration_ms',           NaN, ... %# check if these are good parameters for the duration (ms) Nieder et al. 2023, check the spectra of this to make sure it is not too broadband
    'ramp_duration_ms',                     NaN, ... 
    'ramp_duration_min_ms',                 50, ... 
    'ramp_duration_max_ms',                 170, ...
    'ramp_freq_weight',                     NaN, ...
    'speaker_model',                        'UW-30 Lubell Labs Inc., Columbus, OH, USA Serial #', ...
    'max_amplitude_limit',                  160, ...
    'min_amplitude_limit',                  80, ...
...
% Recording parameters
    ...
    ex.info.recording.hydrophone_gain_mV_per_Pa = 10; % or 10 mV/Pa
...
ex.info.analysis = struct( ... % These values will be updated by prepare_next_amplitude when new amplitude is selected
    ...
    'range_2f_hz',      2, ... % +/- 3 Hz above and below the double frequency response point
