...
ex.info.experiment = struct( ...
    ...
    'exp_type',              NaN, ...
    'test_tag',              NaN, ...
    'drug_name',             'Anesthetic: Timed sulfate; Paralytic: Cisatracurium besylate; Analgesic: Bupivicaine', ...
    ...
    'drug_concentration',    'Anesthetic: 0.025%, 1 ml of 10% solution of Timed in ethynol per 400 ml of water bath; Paralytic: 3 mg kg−1; Analgesic: 1 mg/kg  ', ...
...
ex.info.stimulus = struct( ...
    ...
    'speaker_model',                        'Clark Synthesis Aquasonic Diluvio AQ339 ', ...
...
if strcmp(app.DropDown_test_mode.Value,'Mixed stimuli')
    ex.info.mixed = struct( ...
        'stim_name',              {{'ONOFF'}}, ... % Make this an if statement so it will generate which frequency to look for in the response
        'max_trials',             [10], ... % Auto populate
