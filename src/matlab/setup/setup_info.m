...
% Recording parameters
    ...
    ex.info.recording.hydrophone_gain_mV_per_Pa = 100; % or 100 mV/Pa
...
ex.info.analysis = struct( ... % These values will be updated by prepare_next_amplitude when new amplitude is selected
    ...
    'mad_criteria',            2, ... % Once rms has been reduced 50% check to see if 2f diff peak is 4*mad + median above noise floor
