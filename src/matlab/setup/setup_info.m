...
ex.info.stimulus = struct( ...
    'frequency',                         NaN, ... % In app
    'amplitude',                         140, ... % Value changes later in prepare_next_amp
    'type',                              'tone burst', ...
    'polarity',                          'alternating', ...
    'starting_amp',                      140, ... % Set in app (140)
    'stimulus_waveform',                 NaN, ...
    'ramp_type',                         'Hanning', ...
    'full_amplitude_portion_duration',   50, ... % Nieder et al. 2023, check the spectra of this to make sure it is not too broadband
    'ramp_proportion',                   0.1, ... % Set in app (5 ms)
...
ex.info.recording = struct( ...
    ...
    'downsample_rate',           1000, ... % for data analysis
