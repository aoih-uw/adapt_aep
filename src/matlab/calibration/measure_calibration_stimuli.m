function [hydrophone_rms_dB, rec_data_mV] = measure_calibration_stimuli( ...
    calibration_stim, trigger_stim, waveform, ...
    input_channels, output_channels, electrode_idx, ...
    hydrophone_idx, loopback_idx, ...
    ...
    hydrophone_rms_pa = rms(full_amp_hydrophone_sig*10);
    hydrophone_rms_dB = 20*log10((hydrophone_rms_pa/1e6)/0.000001);
