function [all_data] = ...
    plan_fit_low_CI(amp_vec, lower_ci_vec, boot_std_vec, trials_per_block, max_trials, my_chans_name, my_params,resp_stable)
cur_freq = my_params.cur_freq;
% All_data available data
[p, thresh_ci, stable_n] = ...
    fit_low_CI_model(amp_vec, lower_ci_vec, boot_std_vec, resp_stable, ...
