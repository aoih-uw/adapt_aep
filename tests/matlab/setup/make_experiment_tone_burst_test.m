classdef make_experiment_tone_burst_test < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_expected_stimulus_dur(testCase)
            ...
            result = make_experiment_tone_burst(ex);
        ...
        function test_nyquist_limit_error(testCase)
            ...
            testCase.verifyError(@() make_experiment_tone_burst(ex), 'make_experiment_tone_burst:NyquistViolation');
        end
        ...
        function test_invalid_duration_error(testCase)
            ...
            testCase.verifyError(@() make_experiment_tone_burst(ex), 'make_experiment_tone_burst:InvalidDuration');
        end
